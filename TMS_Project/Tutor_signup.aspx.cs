...
namespace TMS_Project
{
    public partial class Tutor_signup : System.Web.UI.Page
    {
        ...
        protected void TutorSignUpButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "insert into tutor_signup values(@name, @surname, @gender, @age, @email, @subject, @country, @city, @address, @qualification,@degree, @experience, @contactno, @username, @password)";
