...
namespace TMS_Project
{
    public partial class Student_signup : System.Web.UI.Page
    {
        ...
        protected void StudentSignUpButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "insert into student_signup values(@name, @fname, @surname, @gender, @age, @country, @city, @address, @email, @goingto, @subject, @contactno, @tuitiontype, @tutorprefer, @username, @password)";
