<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_dashboard.Master" AutoEventWireup="true" CodeBehind="View_admin_students.aspx.cs" Inherits="TMS_Project.View_admin_students" %>
     ...
     <asp:GridView CssClass="table table-bordered table-hover table-striped table-dark" ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
         <Columns>
             ...
             <asp:TemplateField HeaderText="GENDER">
              ...
              <asp:TemplateField HeaderText="CONTECT NO">
                 <ItemTemplate>
