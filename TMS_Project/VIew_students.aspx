<%@ Page Title="" Language="C#" MasterPageFile="~/Tutor_dashboard.Master" AutoEventWireup="true" CodeBehind="VIew_students.aspx.cs" Inherits="TMS_Project.VIew_students" %>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card bg-dark text-white text-center">
                        ...
                        <div class="card-body">
                            ...
                            <h5>
                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("gender") %>'></asp:Label></h5>
                        ...
                        <div class="card-footer">
                            ...
                            <h4>
                                ...
                                <asp:Label ID="Label7" runat="server" Text='<%#  Bind("tuitiontype") %>'></asp:Label></h4>
                        </div>
                    </div>
                    <br />
                </div>
